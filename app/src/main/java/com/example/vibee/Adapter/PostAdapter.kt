package com.example.vibee.Adapter
...
import com.example.vibee.CommentsActivity
import com.example.vibee.MainActivity
    ...
    private fun numberOfLikes(likes: TextView, postid: String)
    {
        ...
        LikesRef.addValueEventListener(object  :  ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    likes.text = p0.childrenCount.toString() + " Vibe"
                }
            }
    ...
    private fun getTotalComments(comments: TextView, postid: String)
    {
        ...
        commentsRef.addValueEventListener(object  :  ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    comments.text = "View All " + p0.childrenCount.toString() + " Compliments"
                }
            }
